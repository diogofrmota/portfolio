  ...
  return (
    <div className={styles.app}>
      ...
      <main className={styles.main}>
        ...
        {!tmdbConfigured && <div className={styles.configurationNote}><strong>Preview catalogue</strong><span>Add `TMDB_API_KEY` to load live discovery and search results.</span></div>}
