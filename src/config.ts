  ...
  experience: [
    {
      ...
      bullets: [
        ...
        "Architected and executed the migration from an on-premise environment to AWS (EKS)",
        ...
        "Built Grafana dashboards with Prometheus to monitor infrastructure and application metrics",
